  ...
  return (
    ...
    <Box sx={{
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', textAlign: 'center', backgroundColor: '#D5D5D5', paddingY: '30px' }} >
        ...
        <Typography>
          Services /  Imaging and Cataloging Services /  Content Writing
        </Typography>
      </Box>
...
export default ImagingServices6