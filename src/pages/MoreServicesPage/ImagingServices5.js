  ...
  return (
    ...
    <Box sx={{
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', textAlign: 'center', backgroundColor: '#D5D5D5', paddingY: '30px' }} >
        ...
        <Typography>
          Services /  Imaging and Cataloging Services /  Video Production
        </Typography>
      </Box>
      ...
      <CardContent  sx={{direction:'row', justifyContent:'center'}}>
        ...
        Engaging Video Production for Elevated E-commerce Experiences
        </Typography>
...
export default ImagingServices5